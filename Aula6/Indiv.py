...
class Indiv:
    ...
    def __init__(self, size, genes=[], lb=0, ub=1):  # o que caracteriza o individuo sao so seus genes e o fitness(valor de aptidao)| lb e ub sao o intervalo de valores que cada gene pode ter
        ...
        self.genes = genes  # genoma (informacao de  td o individuo)
    ...
    def one_pt_crossover(self, indiv2):  # dar indiv2 para ter o cruzamento
        ...
        res1 = self.__class__(s, offsp1, self.lb,
                              self.ub)  # permite que eu posso usar o mesmo metodo dentro de uma representacao inteira
        res2 = self.__class__(s, offsp2, self.lb,
                              self.ub)  # vou criar uma nova instancia mas com base na representacao do novo
        return res1, res2
